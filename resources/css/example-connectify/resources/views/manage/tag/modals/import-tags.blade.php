<div class="modal fade" id="tags-import" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Import tags by spreadsheet</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('tags.import') }}" method="post" class="ajax-form-submit" enctype="multipart/form-data">
                ...
                <div class="modal-footer d-inline-block w-100">
                    <a href="{{ asset('files/tags.xlsx') }}" class="download-sample-file text-success d-inline-block" download="">Download sample file</a>
