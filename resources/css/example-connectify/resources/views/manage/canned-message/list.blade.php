    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body no-lt-rt-pad">
                @if($is_found)
                    {!! Helper::getDatatables(['Name', 'Type', 'Text', 'Created By', 'Created At', 'Action']) !!}
                @else
                    <div class="text-center mt-2 mb-5">
                        <img src="{{ asset('images/no-cat.svg') }}">
                        <h4>Create canned messages.</h4>
                        <p>Canned messages are responses that you can pre-set and use in your chat repeatedly.</p>
                        <a href="{{ route('canned.message.add') }}" class="btn btn-sm btn-custom me-1">Add canned message</a>
                    </div>
                @endif
            </div>
        </div>
...
@section('meta')
<meta name="class-to-open" content="canned-essages">
    ...
    function createTable()
    {
        ...
        table = $('.datatable').DataTable({
                    ...
                    "layout": {
                        ...
                        topEnd: function () {
                            return `<div class="dt-btns">
                                        <a href="{{ route('canned.message.add') }}" class="btn btn-sm btn-custom me-1">Add New</a>
                    ...
                    "columns":[
                        ...
                        { "data": "text", "name":"filter_index" },
                        { "data": "user_name", "name":"filter_index" },
