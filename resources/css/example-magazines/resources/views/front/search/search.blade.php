                ...
                <div class="col-lg-8 posts-list">
                    <div class="trending-area fix">
                        <div class="trending-main">
                            <div class="row">
                                @if (isset($articles) && !empty($articles)) @forelse ($articles as $article)
                                <div class="col-md-6">
                                    <div class="trending-top mb-30">
                                        <div class="trend-top-img">
                                            @php $images = DB::table('images')->where('article_id', $article->id)->where('featured_image', 1)->first(); @endphp @if(!empty($images->image))
                                            <img src="{{ asset('storage/'. $images->image) }}" alt="" style="height: 300px !important;" /> @endif
                                ...
                                <div class="col-md-6 card d-flex justify-content-center border-0 w-100">
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget tag_cloud_widget">
                            ...
                            <ul class="list">
                                @php $magazines = DB::table('magazines')->get(); @endphp @foreach ($magazines as $magazine)
                                <li>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            @php $articles = DB::table('articles')->where('status', 1)->orderBy('id', 'desc')->take(5)->get();@endphp @foreach ($articles as $key => $article)
                            <div class="media post_item">
                                @php $images = DB::table('images')->where('article_id', $article->id)->where('featured_image', 1)->first(); @endphp @if(!empty($images->image))
                                <img src="{{ asset('storage/'. $images->image) }}" alt="" style="max-height: 80px !important;" /> @endif
