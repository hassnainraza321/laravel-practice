<div id="con-close-modal" class="modal fade edit_popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="item_form" action="{{ route('contact.edit' , $id) }}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="{{ $index }}" name="{{ $index }}" @if(isset($contact->email)) value="{{ $contact->email }}" @endif >
