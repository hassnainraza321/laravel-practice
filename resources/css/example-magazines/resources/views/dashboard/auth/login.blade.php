...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>{{ Helper::getSiteTitle('Log In') }}</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="auth_form" action="{{ route('login') }}" method="post">
                                @csrf
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="remember_me" value="1" id="checkbox-signin" checked>
                                            <label class="form-check-label" for="checkbox-signin">Remember me</label>
                                        </div>
                                    </div>

                                    <div class="text-center d-grid">
                                        <button id="submit_btn" data-form_id="auth_form" class="btn btn-primary"> Log In </button>
                                    </div>
