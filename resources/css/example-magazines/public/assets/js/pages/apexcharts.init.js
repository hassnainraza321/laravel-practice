...
var spark1 = {
    ...
    fill: { opacity: 0.2 },
    series: [{ name: "UBold Sales ", data: randomizeArray(sparklineData) }],
    yaxis: { min: 0 },
    colors: colors,
...
var spark2 = {
    ...
    stroke: { width: 2, curve: "straight" },
    fill: { opacity: 0.2 },
    series: [{ name: "UBold Expenses ", data: randomizeArray(sparklineData) }],
    yaxis: { min: 0 },
    colors: colors,
...
options = {
    ...
    series: [
        ...
        { name: "Central", data: generateDayWiseTimeSeries(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 15 }) },
    ],
...
options = {
    ...
    fill: { opacity: 1 },
    grid: { row: { colors: ["transparent", "transparent"], opacity: 0.2 }, borderColor: "#f1f3fa", padding: { bottom: 10 } },
    tooltip: {
        y: {
...
options = {
    ...
    dataLabels: { enabled: !1 },
    colors: colors,
    grid: { borderColor: "#f1f3fa", xaxis: { showLines: !0 }, yaxis: { showLines: !0 }, padding: { bottom: 10 } },
    legend: { offsetY: 7 },
    xaxis: { type: "datetime" },
    yaxis: { max: 70 },
    responsive: [{ breakpoint: 600, options: { chart: { toolbar: { show: !1 } }, legend: { show: !1 } } }],
...
options = {
    chart: {
        ...
        selection: { xaxis: { min: new Date("20 Jan 2017").getTime(), max: new Date("10 Dec 2017").getTime() }, fill: { color: "#6c757d", opacity: 0.4 }, stroke: { color: "#6c757d" } },
        events: {
            selection: function (e, o) {
                chartCandlestick.updateOptions({ xaxis: { min: o.xaxis.min, max: o.xaxis.max } }, !1, !1);
            },
        },
    },
    dataLabels: { enabled: !1 },
...
colors = ["#6658dd", "#4fc6e1", "#4a81d4", "#00b19d", "#f1556c"];
(dataColors = $("#apex-pie-3").data("colors")) && (colors = dataColors.split(","));
options = {
...
colors = ["#6c757d"];
(dataColors = $("#apex-radialbar-1").data("colors")) && (colors = dataColors.split(","));
options = { chart: { height: 350, type: "radialBar" }, plotOptions: { radialBar: { hollow: { size: "70%" } } }, colors: ["#6c757d"], series: [70], labels: ["CRICKET"] };
